/*
1번친구 : 1,2,3,4,5 순서대로 (for구문써서 배열의길이만큼 반복?)->5개
2번친구 : 짝수번째 2 홀수번째 1,3,4,5(2제외)->8개
3번친구 : 3,3,1,1,4,4,2,2,5,5 ->10개
->1. 배열에 반복되는 숫자들을 적어놓고, if문을 사용하여 나눈 후 나머지값을 이용하면 될듯?
2.각각의 맞힌 갯수를 max로 하여 누가 젤 많이 맞힌 사람을 찾는다.
